...
// The workspace shell: the running application. It wires the stores, hooks, and
// command handlers together and composes the layout (navigation rail, surface
// router, command palette). App mounts this; nothing above it holds app logic.
